"""
Clasificación de Hablantes usando Shallow Machine Learning con Bag of Words
...
print("\nMatriz de confusión guardada en: confusion_matrix_shallow_bow.png")
...
plt.tight_layout()
plt.savefig('shallow_bow_comparison.png', dpi=300, bbox_inches='tight')
print("Gráfico de comparación guardado en: shallow_bow_comparison.png")
...
joblib.dump(vectorizer, 'models/vectorizer_bow.joblib')
print("Vectorizador guardado en: models/vectorizer_bow.joblib")

joblib.dump(best_model, 'models/best_shallow_bow.joblib')
print(f"Mejor modelo ({best_model_name}) guardado en: models/best_shallow_bow.joblib")
...
joblib.dump(results, 'models/results_shallow_bow.joblib')
print("Resultados guardados en: models/results_shallow_bow.joblib")

# Función de predicción
def predecir_hablante_bow(texto, vectorizer, model, label_encoder):
    """
    Predice el hablante usando Bag of Words
    """
...
for ejemplo in ejemplos:
    hablante, confianza = predecir_hablante_bow(
...
print("="*60)
print("\nRESUMEN:")
print(f"- Embedding: Bag of Words ({len(vectorizer.vocabulary_)} features)")
