...
print("\n" + "="*60)
print("VECTORIZACIÓN: TF-IDF (CARACTERES 2-5 GRAMS)")
print("="*60)

vectorizer = TfidfVectorizer(
    analyzer='char',       # Analizar caracteres (no palabras)
    ngram_range=(2, 5),    # 2-gramas a 5-gramas de caracteres
...
joblib.dump(vectorizer, 'models/vectorizer_tfidf_char.joblib')
print("Vectorizador guardado en: models/vectorizer_tfidf_char.joblib")
