...
HIDDEN_DIM, NUM_LAYERS, DROPOUT, BATCH_SIZE, EPOCHS, MAX_LEN = 128, 2, 0.3, 16, 15, 128
...
class GRUBertCLSClassifier(nn.Module):
    def __init__(self, embedding_dim, hidden_dim, num_layers, num_classes, dropout):
        super(GRUBertCLSClassifier, self).__init__()
...
model = GRUBertCLSClassifier(EMBEDDING_DIM, HIDDEN_DIM, NUM_LAYERS, num_classes, DROPOUT).to(device)
