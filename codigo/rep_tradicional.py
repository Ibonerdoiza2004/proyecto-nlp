...
- Construye BoW (1-3) y TF-IDF (palabras 1-2 y caracteres 3-5)
- Mantiene los vectorizadores (joblib) como en el código original
"""
...
# Parsear la columna 'lemmas_no_stop' que viene como string en el CSV
def parse_list(x):
...
# Textos para n-gramas (como en tu código)
...
# TF-IDF de caracteres 3-5 sobre texto limpio
...
# Guardar vectorizadores (igual que en tu bloque original)
